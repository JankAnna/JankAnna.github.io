...
export default function LanguageSwitchButton() {
	...
	return (
		<LanguageWrapper>
			<img src="img/enus.png" alt="United States of America | USA" width={28} height={28} objectFit="cover" />
			<SwitchButton>
			...
			<Image src="img/plpl.png" alt="Poland | Polska" width={28} height={28} objectFit="cover" />
		</LanguageWrapper>
	);
}
