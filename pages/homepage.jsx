...
export default function HomePage() {
	...
	return (
		<SectionHomePage id="section-home">
			...
			<Head title="JankAnna | Anna Zofia Jankowska | Portfolio" metaDescription="Anna Zofia Jankowska, Portfolio - projects,skills,experience " keywords="Anna Zofia Jankowska, Cybersecurity, Programming, Pentesting" />
			<LandingPageContainer>
				<TitleLandingContainer>
					<SubTitleLanding>{language.landingPage.apresentationText}</SubTitleLanding>
					<Typed strings={["Anna Zofia Jankowska"]} typeSpeed={80} className="type-string " />
